package com.example.ec03_smartshop.Network;

import android.content.res.Resources;
import android.net.Uri;
import android.util.Log;

import com.example.ec03_smartshop.R;
...
public class ProductEntry {
    ...
    public static List<ProductEntry> initProductEntryList (Resources resources) {
        ...
        try {
            ...
            Log.e(TAG, "There was an error at the moment of reeding and writing of JSON archive", exception);
        } finally {
            try {
                inputStream.close();
            } catch (IOException exception) {
                Log.e(TAG, "There was an error at the momento of closing the input stream", exception);
            }
        }
